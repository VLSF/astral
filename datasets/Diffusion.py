...
def get_dataset(key, N_samples):
    ...
    for key in keys:
        a_train_, rhs_train_, dx_a_train_, dy_a_train_, a_eval_legendre_, dx_sol_eval_legendre_, dy_sol_eval_legendre_, rhs_legendre_, a_legendre_, sol_eval_, C_F_ = get_sample(key, coords_train, weights_, coords_legendre, coords_eval)
