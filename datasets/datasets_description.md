...
```math
E[u - v]^2 = \int dx \left(K_0\left(\partial_1 (u-v)_1 + \partial_2 (u-v)_2\right)^2 + \delta\left(\frac{1}{2}\left(\partial_1(u-v)_1-\partial_2(u-v)_2\right)^2 + \left(\partial_1(u-v)_2\right)^2 + \left(\partial_2(u-v)_1\right)^2\right)\right)
```
